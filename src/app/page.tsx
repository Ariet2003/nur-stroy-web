    ...
    <div className="min-h-screen bg-white" onClick={handleClickOutside}>
      ...
      <section id="home" className="relative min-h-screen flex items-center justify-center pt-16">
        ...
        <div className="relative z-10 text-center text-white px-4 sm:px-6">
          <h1 className="text-3xl sm:text-5xl md:text-7xl font-bold mb-4 sm:mb-6 text-white drop-shadow-2xl" style={{textShadow: '2px 2px 4px rgba(0,0,0,0.8)'}}>NUR STROY</h1>
          ...
          <div className="bg-white rounded-2xl p-12 shadow-lg">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
              ...
              <div className="text-center group">
                ...
                <div className="text-xs sm:text-sm text-gray-500 mt-1">На рынке Казахстана</div>
              </div>
            ...
            <div className="lg:col-span-2">
              ...
              <div>
                ...
                <div className="flex gap-3">
                  {/* Instagram */}
                  <a href="https://instagram.com/nurstroy.company" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/10 rounded-lg flex items-center justify-center hover:bg-white/20 transition duration-300">
